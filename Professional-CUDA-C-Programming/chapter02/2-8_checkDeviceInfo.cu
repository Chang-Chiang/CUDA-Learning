/**
 * @file 2-8_checkDeviceInfo.cu
 * @author Chang Chiang (Chang_Chiang@outlook.com)
 * @brief Display a variety of information on the first CUDA device in this system,
 * including driver version, runtime version, compute capability, bytes of global memory, etc.
 *
 * nvcc 2-8_checkDeviceInfo.cu -o checkDeviceInfo.cu
 * @version 0.1
 * @date 2025-02-23
 *
